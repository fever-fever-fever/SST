 ...
 * <p>
 * The <code>{@link com.example.stt.sampled.AudioSystem}</code> class includes methods for determining the format
...
public class AudioFileFormat {
     ...
     */
    private com.example.stt.sampled.AudioFormat format;
     ...
     * @see #getType
     */
    protected AudioFileFormat(Type type, int byteLength, com.example.stt.sampled.AudioFormat format, int frameLength) {
     ...
     * @param frameLength the audio data length in sample frames, or <code>AudioSystem.NOT_SPECIFIED</code>
     */
    public AudioFileFormat(Type type, com.example.stt.sampled.AudioFormat format, int frameLength) {


        this(type, com.example.stt.sampled.AudioSystem.NOT_SPECIFIED,format,frameLength);
    }
     ...
     * @since 1.5
     */
    public AudioFileFormat(Type type, com.example.stt.sampled.AudioFormat format,
    ...
    public String toString() {
        ...
        if (byteLength != com.example.stt.sampled.AudioSystem.NOT_SPECIFIED) {
