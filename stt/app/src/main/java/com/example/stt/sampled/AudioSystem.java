...
package com.example.stt.sampled;
...
import com.example.stt.sampled.AudioFileFormat;
import com.example.stt.sampled.AudioInputStream;
import com.example.stt.sampled.AudioPermission;
import com.example.stt.sampled.LineUnavailableException;
import com.example.stt.sampled.SourceDataLine;
import com.example.stt.sampled.UnsupportedAudioFileException;
import com.example.stt.sampled.spi.AudioFileWriter;
import com.example.stt.sampled.spi.AudioFileReader;
import com.example.stt.sampled.spi.FormatConversionProvider;
import com.example.stt.sampled.spi.MixerProvider;
 ...
 *  </tr>
 *  <tr>
 *   <td><code>com.example.stt.sampled.Clip</code></td>
 *   <td>{@link Clip}</td>
 *   <td>{@link #getLine}, {@link #getClip}</td>
 *  </tr>
 *  <tr>
 *   <td><code>com.example.stt.sampled.Port</code></td>
 *   <td>{@link Port}</td>
 *   <td>{@link #getLine}</td>
 *  </tr>
 *  <tr>
 *   <td><code>com.example.stt.sampled.SourceDataLine</code></td>
 *   <td>{@link SourceDataLine}</td>
 *   <td>{@link #getLine}, {@link #getSourceDataLine}</td>
 *  </tr>
 *  <tr>
 *   <td><code>com.example.stt.sampled.TargetDataLine</code></td>
 ...
 * name of a concrete {@link com.example.stt.sampled.spi.MixerProvider
 ...
 *
 * For example, the property <code>com.example.stt.sampled.Clip</code>
 * with a value
 ...
 *
 * @see com.example.stt.sampled.AudioFormat
...
public class AudioSystem {
     ...
     * <code>com.example.stt.sampled.Clip</code>,
     * <code>com.example.stt.sampled.Port</code>,
     * <code>com.example.stt.sampled.SourceDataLine</code> and
     * <code>com.example.stt.sampled.TargetDataLine</code> are defined
    ...
    public static Clip getClip() throws LineUnavailableException{
        com.example.stt.sampled.AudioFormat format = new com.example.stt.sampled.AudioFormat(com.example.stt.sampled.AudioFormat.Encoding.PCM_SIGNED,
                                             AudioSystem.NOT_SPECIFIED,
                                             16, 2, 4,
                                             AudioSystem.NOT_SPECIFIED, true);
        com.example.stt.sampled.DataLine.Info info = new com.example.stt.sampled.DataLine.Info(Clip.class, format);
     ...
     *
     * <p>If the system property
     * <code>com.example.stt.sampled.SourceDataLine</code>
     * is defined or it is defined in the file &quot;sound.properties&quot;,
     ...
     *
     * @see #getSourceDataLine(com.example.stt.sampled.AudioFormat, Mixer.Info)
     * @since 1.5
     */
    public static SourceDataLine getSourceDataLine(com.example.stt.sampled.AudioFormat format)
        throws LineUnavailableException{
        com.example.stt.sampled.DataLine.Info info = new com.example.stt.sampled.DataLine.Info(SourceDataLine.class, format);
     ...
     *
     * @see #getSourceDataLine(com.example.stt.sampled.AudioFormat)
     * @since 1.5
     */
    public static SourceDataLine getSourceDataLine(com.example.stt.sampled.AudioFormat format,
     ...
     *
     * <p>If the system property
     * {@code com.example.stt.sampled.TargetDataLine}
     * is defined or it is defined in the file &quot;sound.properties&quot;,
     ...
     *         specified audio format through any installed mixer
     *
     * @see #getTargetDataLine(com.example.stt.sampled.AudioFormat, Mixer.Info)
     * @see AudioPermission
     * @since 1.5
     */
    public static TargetDataLine getTargetDataLine(com.example.stt.sampled.AudioFormat format)
        throws LineUnavailableException{

        com.example.stt.sampled.DataLine.Info info = new com.example.stt.sampled.DataLine.Info(TargetDataLine.class, format);
     ...
     *         the specified audio format
     *
     * @see #getTargetDataLine(com.example.stt.sampled.AudioFormat)
     * @see AudioPermission
     * @since 1.5
     */
    public static TargetDataLine getTargetDataLine(com.example.stt.sampled.AudioFormat format,
        ...
        com.example.stt.sampled.DataLine.Info info = new DataLine.Info(TargetDataLine.class, format);
        Mixer mixer = AudioSystem.getMixer(mixerinfo);
     ...
     */
    public static com.example.stt.sampled.AudioFormat.Encoding[] getTargetEncodings(com.example.stt.sampled.AudioFormat.Encoding sourceEncoding) {

        List codecs = getFormatConversionProviders();
        Vector encodings = new Vector();

        com.example.stt.sampled.AudioFormat.Encoding encs[] = null;
        ...
        com.example.stt.sampled.AudioFormat.Encoding encs2[] = (com.example.stt.sampled.AudioFormat.Encoding[]) encodings.toArray(new com.example.stt.sampled.AudioFormat.Encoding[0]);
        return encs2;
    }
     ...
     */
    public static com.example.stt.sampled.AudioFormat.Encoding[] getTargetEncodings(com.example.stt.sampled.AudioFormat sourceFormat) {
        ...
        com.example.stt.sampled.AudioFormat.Encoding encs2[] = new com.example.stt.sampled.AudioFormat.Encoding[size];
        for(int i=0; i<encodings.size(); i++ ) {
            encs = (com.example.stt.sampled.AudioFormat.Encoding [])(encodings.get(i));
            for(int j=0; j<encs.length; j++ ) {
                encs2[index++] = encs[j];
            }
        }
     ...
     */
    public static boolean isConversionSupported(com.example.stt.sampled.AudioFormat.Encoding targetEncoding, com.example.stt.sampled.AudioFormat sourceFormat) {
     ...
     * @see #getTargetEncodings(com.example.stt.sampled.AudioFormat.Encoding)
     * @see #getTargetEncodings(com.example.stt.sampled.AudioFormat)
     * @see #isConversionSupported(com.example.stt.sampled.AudioFormat.Encoding, com.example.stt.sampled.AudioFormat)
     * @see #getAudioInputStream(com.example.stt.sampled.AudioFormat, AudioInputStream)
     */
    public static AudioInputStream getAudioInputStream(com.example.stt.sampled.AudioFormat.Encoding targetEncoding,
     ...
     */
    public static com.example.stt.sampled.AudioFormat[] getTargetFormats(com.example.stt.sampled.AudioFormat.Encoding targetEncoding, com.example.stt.sampled.AudioFormat sourceFormat) {
        ...
        int size = 0;
        int index = 0;
        com.example.stt.sampled.AudioFormat fmts[] = null;
        ...
        com.example.stt.sampled.AudioFormat fmts2[] = new com.example.stt.sampled.AudioFormat[size];
        for(int i=0; i<formats.size(); i++ ) {
            fmts = (com.example.stt.sampled.AudioFormat[])(formats.get(i));
    ...
    public static boolean isConversionSupported(com.example.stt.sampled.AudioFormat targetFormat, com.example.stt.sampled.AudioFormat sourceFormat) {
     ...
     * @see #getTargetFormats(com.example.stt.sampled.AudioFormat.Encoding, com.example.stt.sampled.AudioFormat)
     * @see #isConversionSupported(com.example.stt.sampled.AudioFormat, com.example.stt.sampled.AudioFormat)
     * @see #getAudioInputStream(com.example.stt.sampled.AudioFormat.Encoding, AudioInputStream)
     */
     ...
     * @return an array of
     * {@link com.example.stt.sampled.spi.FormatConversionProvider
     ...
     * @return a List of
     * {@link com.example.stt.sampled.spi.AudioFileReader
     * AudioFileReader}
     ...
     * @return a List of
     * {@link com.example.stt.samples.spi.AudioFileWriter AudioFileWriter}
