 ...
 * an appropriate <code>{@link com.example.stt.sampled.DataLine.Info}</code> object.
 * <p>
 ...
 * <code>{@link com.example.stt.sampled.DataLine#available available}</code> method defined in the
 ...
 * @author Kara Kytle
 * @see Mixer
 * @see com.example.stt.sampled.DataLine
 * @see TargetDataLine
 * @since 1.3
 */
public interface SourceDataLine extends com.example.stt.sampled.DataLine {
     ...
     * queried by subsequently calling <code>{@link com.example.stt.sampled.DataLine#getBufferSize}</code>.
     * <p>
     ...
     *
     * @see #open(com.example.stt.sampled.AudioFormat)
     * @see Line#open
     * @see Line#close
     * @see Line#isOpen
     * @see LineEvent
     */
    public void open(com.example.stt.sampled.AudioFormat format, int bufferSize) throws LineUnavailableException;
     ...
     * <code>{@link com.example.stt.sampled.DataLine#getBufferSize}</code>.
     * <p>
     * If this operation succeeds, the line is marked as open, and an
     * <code>{@link LineEvent.Type#OPEN OPEN}</code> event is dispatched to the
     * line's listeners.
     ...
     * opened due to security restrictions
     *
     * @see #open(com.example.stt.sampled.AudioFormat, int)
     * @see Line#open
     * @see Line#close
     * @see Line#isOpen
     * @see LineEvent
     ...
     * currently be written (see <code>{@link com.example.stt.sampled.DataLine#available available}</code>),
     ...
     * using the <code>{@link com.example.stt.sampled.DataLine#available available}</code> method of the
