 ...
 *
 * @see com.example.stt.sampled.AudioSystem
...
public class AudioInputStream extends InputStream {
     ...
     */
    protected com.example.stt.sampled.AudioFormat format;
     ...
     */
    public AudioInputStream(InputStream stream, com.example.stt.sampled.AudioFormat format, long length) {
        ...
        if( this.frameSize == com.example.stt.sampled.AudioSystem.NOT_SPECIFIED || frameSize <= 0) {
            this.frameSize = 1;
        }
     ...
     * @see com.example.stt.sampled.AudioSystem#NOT_SPECIFIED
     */
    public AudioInputStream(com.example.stt.sampled.TargetDataLine line) {

        TargetDataLineInputStream tstream = new TargetDataLineInputStream(line);
        format = line.getFormat();
        frameLength = com.example.stt.sampled.AudioSystem.NOT_SPECIFIED;
        frameSize = format.getFrameSize();

        if( frameSize == com.example.stt.sampled.AudioSystem.NOT_SPECIFIED || frameSize <= 0) {
            frameSize = 1;
        }
        this.stream = tstream;
        framePos = 0;
     ...
     */
    public com.example.stt.sampled.AudioFormat getFormat() {
        return format;
    }
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        ...
        if( frameLength != com.example.stt.sampled.AudioSystem.NOT_SPECIFIED ) {
    ...
    private class TargetDataLineInputStream extends InputStream {
         ...
         */
        com.example.stt.sampled.TargetDataLine line;
