 ...
 * @see com.example.stt.sampled.DataLine#getFormat
 * @see AudioInputStream#getFormat
 * @see AudioFileFormat
 * @see com.example.stt.sampled.spi.FormatConversionProvider
 * @since 1.3
 */
public class AudioFormat {
     ...
     * com.example.stt.sampled.DataLine.Info#getFormats() DataLine.Info.getFormats}), a sample rate of
     ...
     * AudioSystem#isConversionSupported(AudioFormat, AudioFormat)
     * AudioSystem.isConversionSupported}) or capabilities (e.g. {@link
     * com.example.stt.sampled.DataLine.Info#getFormats() DataLine.Info.getFormats}), a sample size of
     ...
     * AudioSystem#isConversionSupported(AudioFormat, AudioFormat)
     * AudioSystem.isConversionSupported}) or capabilities (e.g. {@link
     * com.example.stt.sampled.DataLine.Info#getFormats() DataLine.Info.getFormats}), a return value of
     ...
     * AudioSystem#isConversionSupported(AudioFormat, AudioFormat)
     * AudioSystem.isConversionSupported}) or capabilities (e.g. {@link
     * com.example.stt.sampled.DataLine.Info#getFormats() DataLine.Info.getFormats}), a frame size of
