...
/**
 * A target data line is a type of <code>{@link com.example.stt.sampled.DataLine}</code> from which
 ...
 * <code>{@link com.example.stt.sampled.DataLine.Info}</code> object.
 * <p>
 ...
 * @since 1.3
 */
public interface TargetDataLine extends com.example.stt.sampled.DataLine {
     ...
     * that the system has chosen may be queried by subsequently calling <code>{@link com.example.stt.sampled.DataLine#getBufferSize}</code>
     * <p>
     * If this operation succeeds, the line is marked as open, and an
     * <code>{@link LineEvent.Type#OPEN OPEN}</code> event is dispatched to the
     * line's listeners.
