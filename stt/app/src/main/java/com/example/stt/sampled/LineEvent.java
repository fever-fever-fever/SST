...
public class LineEvent extends java.util.EventObject {
    ...
    public static class Type {
         ...
         * {@link com.example.stt.sampled.DataLine#start start} request.
         * @see #STOP
         * @see com.example.stt.sampled.DataLine#start
         */
         ...
         * of audio data in response to a {@link com.example.stt.sampled.DataLine#stop stop} request,
         * or because the end of media has been reached.
         * @see #START
         * @see com.example.stt.sampled.DataLine#stop
         */
